...
ROC-AUC	0.87 (Gradient Boosting),	0.85 (Logistic Regression)
Precision	0.82 (Gradient Boosting),	0.79 (Logistic Regression)
Recall	0.84 (Gradient Boosting),	0.81 (Logistic Regression)
...
Использование
Запустите notebook:
jupyter notebook scoring_model.ipynb
